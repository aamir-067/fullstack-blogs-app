    ...
    return (
        <View>
            <View className="h-[72px] w-full flex flex-row justify-between">
                <Image className="aspect-square rounded-lg" source={{ uri: "https://images.unsplash.com/photo-1561889758-ab68199043d9?q=80&w=3267&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" }} />
                {/* // content */}
                ...
                <View className=" flex flex-row justify-between w-9/12 items-center">
                    ...
                    <View className="flex">
                        <View className="flex flex-row gap-2 items-center">
                            ...
                            <Text className="text-sm" style={{ fontFamily: "montserrat-regular" }}>Nicolas johns.</Text>
                        </View>
                        <Text className="text-2xl" style={{ fontFamily: "rufina-bold" }}>Heading of article</Text>
                    </View>


                    <View className=" w-3/12 flex items-center justify-center -mt-4  border-2 rounded-full" style={{ borderColor: "#C3D8B3" }}>
                        <Text className="text-xs p-2" style={{ fontFamily: "montserrat-regular", color: "#C3D8B3" }}>5 min</Text>
                    </View>
